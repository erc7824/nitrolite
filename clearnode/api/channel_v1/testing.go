...
func (m *MockStore) GetUserChannels(wallet string, status *string, asset *string, limit, offset uint32) ([]core.Channel, uint32, error) {
	args := m.Called(wallet, status, asset, limit, offset)
	if args.Get(0) == nil {
