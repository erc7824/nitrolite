...
func NewRPCRouter(
	...
	appSessionV1Group := r.Node.NewGroup("app_session.v1")
	appSessionV1Group.Handle("app_session.v1.submit_deposit_state", appSessionV1Handler.SubmitDepositState)
	appSessionV1Group.Handle("app_session.v1.submit_app_state", appSessionV1Handler.SubmitAppState)
	appSessionV1Group.Handle("app_session.v1.rebalance_app_sessions", appSessionV1Handler.RebalanceAppSessions)
	appSessionV1Group.Handle("app_session.v1.create_app_session", appSessionV1Handler.CreateAppSession)
	appSessionV1Group.Handle("app_session.v1.get_app_definition", appSessionV1Handler.GetAppDefinition)
	appSessionV1Group.Handle("app_session.v1.get_app_sessions", appSessionV1Handler.GetAppSessions)

	channelV1Group := r.Node.NewGroup("channel.v1")
	channelV1Group.Handle("channel.v1.get_escrow_channel", channelV1Handler.GetEscrowChannel)
	channelV1Group.Handle("channel.v1.get_home_channel", channelV1Handler.GetHomeChannel)
	channelV1Group.Handle("channel.v1.get_latest_state", channelV1Handler.GetLatestState)
	channelV1Group.Handle("channel.v1.request_creation", channelV1Handler.RequestCreation)
	channelV1Group.Handle("channel.v1.submit_state", channelV1Handler.SubmitState)

	nodeV1Group := r.Node.NewGroup("node.v1")
	nodeV1Group.Handle("node.v1.get_assets", nodeV1Handler.GetAssets)
	nodeV1Group.Handle("node.v1.get_config", nodeV1Handler.GetConfig)

	userV1Group := r.Node.NewGroup("user.v1")
	userV1Group.Handle("user.v1.get_balances", userV1Handler.GetBalances)
	userV1Group.Handle("user.v1.get_transactions", userV1Handler.GetTransactions)
