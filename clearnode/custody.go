...
func (c *Custody) UpdateBalanceMetrics(ctx context.Context, assets []Asset, metrics *Metrics) {
	...
	for _, asset := range assets {
		...
		logger.Infow("Updated contract balance metrics", "network", c.chainID, "asset", asset.Symbol, "available", availableBalance.String(), "channels", info.ChannelCount.String())
