...
func migrateSqlite(db *gorm.DB) error {
	if err := db.AutoMigrate(&AppLedgerEntryV1{}, &Channel{}, &AppSessionV1{}, &ContractEvent{}, &BlockchainAction{}, &SessionKeyStateV1{}, &SessionKeyApplicationV1{}, &SessionKeyAppSessionIDV1{}); err != nil {
		return err
	}
	return nil
}
