...
contract ECDSAValidatorTest_validateChallengerSignature is ECDSAValidatorTest_Base {
    function test_success_withEip191SigFromUser() public view {
        bytes memory message = abi.encodePacked(Utils.pack(CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signEip191(vm, USER_PK, message);
    ...
    function test_success_withRawEcdsaSigFromUser() public view {
        bytes memory message = abi.encodePacked(Utils.pack(CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signRaw(vm, USER_PK, message);
    ...
    function test_success_withEip191SigFromNode() public view {
        bytes memory message = abi.encodePacked(Utils.pack(CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signEip191(vm, NODE_PK, message);

        ValidationResult result = validator.validateChallengerSignature(CHANNEL_ID, SIGNING_DATA, signature, user, node);
        assertEq(ValidationResult.unwrap(result), ValidationResult.unwrap(VALIDATION_SUCCESS));
    }

    function test_success_withRawEcdsaSigFromNode() public view {
        bytes memory message = abi.encodePacked(Utils.pack(CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signRaw(vm, NODE_PK, message);
    ...
    function test_failure_withEip191SigFromUserWithoutChallenge() public view {
        bytes memory message = Utils.pack(CHANNEL_ID, SIGNING_DATA);
        bytes memory signature = TestUtils.signEip191(vm, USER_PK, message);
    ...
    function test_failure_withRawEcdsaSigFromUserWithoutChallenge() public view {
        bytes memory message = Utils.pack(CHANNEL_ID, SIGNING_DATA);
        bytes memory signature = TestUtils.signRaw(vm, USER_PK, message);
    ...
    function test_failure_withEip191SigFromNodeWithoutChallenge() public view {
        bytes memory message = Utils.pack(CHANNEL_ID, SIGNING_DATA);
        bytes memory signature = TestUtils.signEip191(vm, NODE_PK, message);
    ...
    function test_failure_withRawEcdsaSigFromNodeWithoutChallenge() public view {
        bytes memory message = Utils.pack(CHANNEL_ID, SIGNING_DATA);
        bytes memory signature = TestUtils.signRaw(vm, NODE_PK, message);
    ...
    function test_failure_withEip191SigFromUserWithOtherChannelId() public view {
        bytes memory message = abi.encodePacked(Utils.pack(OTHER_CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signEip191(vm, USER_PK, message);
    ...
    function test_failure_withRawEcdsaSigFromUserWithOtherChannelId() public view {
        bytes memory message = abi.encodePacked(Utils.pack(OTHER_CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signRaw(vm, USER_PK, message);
    ...
    function test_failure_withEip191SigFromNodeWithOtherChannelId() public view {
        bytes memory message = abi.encodePacked(Utils.pack(OTHER_CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signEip191(vm, NODE_PK, message);
    ...
    function test_failure_withRawEcdsaSigFromNodeWithOtherChannelId() public view {
        bytes memory message = abi.encodePacked(Utils.pack(OTHER_CHANNEL_ID, SIGNING_DATA), "challenge");
        bytes memory signature = TestUtils.signRaw(vm, NODE_PK, message);
