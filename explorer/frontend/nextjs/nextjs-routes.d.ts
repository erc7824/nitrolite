...
declare module "nextjs-routes" {
  export type Route =
    ...
    | StaticRoute<"/api/channels">
    | StaticRoute<"/api/config">
    | StaticRoute<"/api/csrf">
    | StaticRoute<"/api/healthz">
    | StaticRoute<"/api/latest-channels">
    | StaticRoute<"/api/latest-entries">
    | StaticRoute<"/api/latest-ledger-entries">
    | StaticRoute<"/api/ledger-entries">
    | StaticRoute<"/api/log">
    | StaticRoute<"/api/media-type">
    | StaticRoute<"/api/metrics">
    | StaticRoute<"/api/monitoring/invalid-api-schema">
    | StaticRoute<"/api/proxy">
    | StaticRoute<"/api/quick-search">
    | StaticRoute<"/api/test">
