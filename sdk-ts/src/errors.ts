/**
 * Error handling system for Hachi SDK
 * 
...
/**
 * Base class for all Hachi SDK errors
 */
 ...
 */
export class ValidationError extends HachiError {
  constructor(
    message: string,
 ...
 */
export class NetworkError extends HachiError {
  constructor(
    message: string,
 ...
 */
export class TimeoutError extends HachiError {
  constructor(
    message: string,
 ...
 */
export class AuthenticationError extends HachiError {
  constructor(
    message: string,
 ...
 */
export class StateError extends HachiError {
  constructor(
    message: string,
 ...
 */
export class ContractError extends HachiError {
  constructor(
    message: string,
...
export class InvalidParameterError extends ValidationError {
  constructor(
    ...
    super(
      ...
      'INVALID_PARAMETER',
      400,
      'Check the parameter value against the API documentation',
      details
    );
  }
}
...
export class InvalidSignatureError extends AuthenticationError {
  constructor(
    ...
    super(
      ...
      'INVALID_SIGNATURE',
      401,
      'Ensure you are using the correct signing key and data',
      details
    );
  }
}
...
export class UnauthorizedError extends AuthenticationError {
  constructor(
    message: string = 'Unauthorized operation',
    details?: Record<string, any>
  ) {
    super(
      message,
...
export class RequestTimeoutError extends TimeoutError {
  constructor(
    ...
    super(
      ...
      'REQUEST_TIMEOUT',
      408,
      'Consider increasing the timeout or retries in the configuration',
      details
    );
  }
}
...
export class ConnectionError extends NetworkError {
  constructor(
    ...
    super(
      ...
      'CONNECTION_FAILED',
      503,
      'Check that the remote endpoint is available and reachable',
      details
    );
  }
}
...
export class StateNotInitializedError extends StateError {
  constructor(
    ...
    super(
      `${stateType} is not initialized`,
      'STATE_NOT_INITIALIZED',
      400,
      `Initialize the ${stateType.toLowerCase()} before using it`,
      details
    );
  }
}
...
export class NotParticipantError extends UnauthorizedError {
  constructor(
    ...
    super(
      `Address${addressStr} is not a participant${channelStr}`,
      {
        ...details,
        address,
        channelId
...
export class MethodNotFoundError extends ValidationError {
  constructor(
    ...
    super(
      `Method${methodStr} not found`,
      'METHOD_NOT_FOUND',
      404,
      'Verify the method name and that it is registered on the server',
      details
    );
  }
}
 ...
 */
export class RPCError extends HachiError {
  constructor(
    message: string,
    rpcCode: number,
    details?: Record<string, any>
    ...
    super(
      ...
      `RPC_ERROR_${rpcCode}`,
      500,
      'Check the RPC error code for more information',
      details
    );
  }
}
...
export class InvalidRPCParamsError extends ValidationError {
  constructor(
    message: string = 'Invalid RPC parameters',
    details?: Record<string, any>
  ) {
    super(
      message,
      'INVALID_RPC_PARAMS',
      400,
      'Check the parameters against the RPC method documentation',
      details
    );
  }
}
 ...
 */
export class VirtualChannelError extends HachiError {
  constructor(
    message: string,
...
export class NoNextHopError extends VirtualChannelError {
  constructor(
    ...
    super(
      `No next hop found${addressStr}`,
      'NO_NEXT_HOP',
      404,
      'Verify that the LVCI path is configured correctly',
      details
    );
  }
}
...
export class RelayError extends VirtualChannelError {
  constructor(
    message: string = 'Failed to relay message',
    details?: Record<string, any>
  ) {
    super(
      message,
      'RELAY_FAILED',
      500,
      'Check that all intermediaries in the path are available',
      details
    );
  }
}
...
export class ContractCallError extends ContractError {
  constructor(
    message: string = 'Contract call failed',
    details?: Record<string, any>
  ) {
    super(
      message,
      ...
      500,
      'Check the contract call parameters and transaction settings',
      details
    );
  }
}
...
export class TransactionError extends ContractError {
  constructor(
    ...
    super(
      ...
      'TRANSACTION_FAILED',
      500,
      'Verify transaction parameters and ensure sufficient funds',
      details
    );
  }
}
...
export class InsufficientBalanceError extends TokenError {
  constructor(
    ...
    super(
      ...
      400,
      'Ensure you have enough tokens to complete this operation',
      {
        ...details,
        tokenAddress,
        required,
...
export class InsufficientAllowanceError extends TokenError {
  constructor(
    ...
    super(
      ...
      400,
      'Approve the token for the required amount before continuing',
      {
        ...details,
        tokenAddress,
        spender,
