  ...
  if (step === 1) {
    return (
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        ...
        <p className="text-gray-600 mb-4">Connect your MetaMask wallet to continue</p>
        <button 
          onClick={connectWallet}
          className="bg-[#3531ff] hover:bg-[#2b28cc] text-white font-bold py-2 px-4 rounded transition-colors cursor-pointer"
        >
          Connect MetaMask
        </button>
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold">Step 2: Select Token & Amount</h2>
        <div className="flex items-center space-x-2">
          <span className="text-sm bg-white border border-gray-200 py-1 px-2 rounded font-mono text-gray-700 shadow-sm">{account?.substring(0, 6)}...{account?.substring(38)}</span>
          <button 
      ...
      <button 
        ...
        className={`w-full py-2 px-4 rounded font-bold ${
          !selectedToken || !amount || assetsSnapshot.balancesLoading
            ...
            : 'bg-[#3531ff] hover:bg-[#2b28cc] transition-colors cursor-pointer'
        } text-white`}
      >
